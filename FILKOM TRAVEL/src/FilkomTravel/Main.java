    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < pelanggan.length; i++) {
            ...
            do {
                ...
                durasi = ChronoUnit.DAYS.between(pemesanan.getTanggalAwal(), pemesanan.getTanggalAkhir());
            ...
            do {
                ...
                if (penumpang <= 4 && penumpang > 0) {
                    pemesanan.setKendaraan(new KendaraanKecil());
                } else if (penumpang <= 6) {
                    pemesanan.setKendaraan(new KendaraanSedang());
                } else if (penumpang <= 8) {
                    pemesanan.setKendaraan(new KendaraanBesar());
                } else {
